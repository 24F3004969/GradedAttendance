...
/**
    ...
    public void start(Stage primaryStage) {
        ...
        String svgUrl = String.valueOf(GradedResourceLoader.loadURL("icons/microphone.svg"));
        ...
        scene.getStylesheets().add(GradedResourceLoader.loadURL("css/svg-image-view-app.css").toExternalForm());
    ...
    private Node createSizeControl(DoubleProperty imageView) {
        Spinner<Double> spinner = new Spinner<>(50, 3000, 100, 50);
